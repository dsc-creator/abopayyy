      ...
      {isAdmin && (
        <div className="px-3 pt-2">
          <NavLink
            to="/admin"
            onClick={() => setMobileOpen && setMobileOpen(false)}
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl font-dm text-sm text-secondary/80 hover:text-secondary hover:bg-secondary/8 border border-dashed border-secondary/20 hover:border-secondary/40 transition-all duration-200"
          >
            <FiShield size={17} />
            Admin Panel
          </NavLink>
